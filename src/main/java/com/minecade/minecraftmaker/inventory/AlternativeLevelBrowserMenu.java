...
public class AlternativeLevelBrowserMenu extends AbstractDisplayableLevelMenu {
	...
	public static AlternativeLevelBrowserMenu getInstance(MinecraftMakerPlugin plugin, UUID viewerId) {
		checkNotNull(plugin);
		checkNotNull(viewerId);
		AlternativeLevelBrowserMenu menu = userLevelBrowserMenuMap.get(viewerId);
		if (menu == null) {
			menu = new AlternativeLevelBrowserMenu(plugin, viewerId);
		}
	...
	public static void updateLevelCount(long levelCount) {
		...
		if (levelCount != AlternativeLevelBrowserMenu.levelCount) {
			AlternativeLevelBrowserMenu.levelCount = levelCount;
		}
	}
	...
	public static void updatePlayerMenu(UUID playerId, Set<MakerDisplayableLevel> levels) {
		...
		AlternativeLevelBrowserMenu menu = userLevelBrowserMenuMap.get(playerId);
		if (menu != null) {
			menu.update(levels);
		}
	}

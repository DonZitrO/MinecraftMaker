...
public class CuboidRegion extends AbstractRegion implements FlatRegion {
	...
	public Region getFaces() {
		...
		// Project to Z-Y plane
		        new CuboidRegion(pos1.setX(min.getX()), pos2.setX(min.getX())), new CuboidRegion(pos1.setX(max.getX()), pos2.setX(max.getX())),

		        // Project to X-Y plane
		        new CuboidRegion(pos1.setZ(min.getZ()), pos2.setZ(min.getZ())), new CuboidRegion(pos1.setZ(max.getZ()), pos2.setZ(max.getZ())),

		        // Project to the X-Z plane
		        new CuboidRegion(pos1.setY(min.getY()), pos2.setY(min.getY())), new CuboidRegion(pos1.setY(max.getY()), pos2.setY(max.getY())));
	}
	...
	public Iterator<BlockVector> iterator() {
		return new Iterator<BlockVector>() {
			...
			private int nextY = max.getBlockY();
	...
	/**
	 * Make a cuboid region out of the given region using the minimum and
	 * maximum bounds of the provided region.
	 *
	 * @param region
	 *            the region

package com.minecade.minecraftmaker.schematic.util;
 ...
 * {@link #equals(Object)} are subject to minor differences caused by floating
 * point errors.
 * </p>
 */
public class Location {
	...
	/**
	 * Create a new instance in the given extent at 0, 0, 0 with a direction
	 * vector of 0, 0, 0.
	 *
	 * @param extent
	 *            the extent
	...
	/**
	 * Create a new instance in the given extent with the given coordinates with
	 * a direction vector of 0, 0, 0.
	 *
	 * @param extent
	 *            the extent
	 * @param x
	 ...
	 * and a direction vector of 0, 0, 0.
	 *
	 * @param extent
	 *            the extent
	 * @param position
	...
	/**
	 * Create a new instance in the given extent with the given coordinates and
	...
	/**
	 * Return a copy of this object with the X component of the new object set
	 * to the given value.
	 *
	 * @param x
	...
	/**
	 * Return a copy of this object with the Y component of the new object set
	 * to the given value.
	 *
	 * @param y
	...
	/**
	 * Return a copy of this object with the Z component of the new object set
	 * to the given value.
	 *
	 * @param z
	 *            the new value for the Y component
